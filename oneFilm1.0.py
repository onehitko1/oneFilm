...
lista_generos = ['https://www.imdb.com/list/ls068082370/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls000551766/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls055874673/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls045017156/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls062101934/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls076655138/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls076166467/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls069376839/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls064252275/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls064287418/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls027738538/?sort=list_order,asc&st_dt=&mode=detail&page=',
                 'https://www.imdb.com/list/ls032616214/?sort=list_order,asc&st_dt=&mode=detail&page=',
...
while not sair:
    ...
    def randomizar_filme(imdb_top_1000_rating):
        filme_escolhido = random.choice(imdb_top_1000_rating())
        return filme_escolhido

    def start():
        detalhes_filme(requisicao_omdb(randomizar_filme(procurar_id_filmes)))
